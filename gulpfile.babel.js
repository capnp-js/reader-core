...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-reader-core.js",
      format: "umd",
      name: "capnpJsReaderCore",
      sourcemap: true,
      globals: {
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-reader-core.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-reader-core.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-reader-core.js.map",
            },
          }))
